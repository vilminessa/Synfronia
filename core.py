...
I18N = {
    "ru": {
        ...
        "clicker.unlocked": "Секретная тема «Vilmy~» открыта!",
        "p.ready": "Готов.",
        "p.start": "Запуск…",
    ...
    "en": {
        ...
        "clicker.unlocked": "Secret theme 'Vilmy~' unlocked!",
        "p.ready": "Ready.",
        "p.start": "Starting…",
    ...
    "ja": {
        ...
        "clicker.unlocked": "秘密のテーマ「Vilmy~」を解放しました！",
        "p.ready": "準備完了。",
        "p.start": "開始中…",
    ...
    "zh-CN": {
        ...
        "clicker.unlocked": "解锁了秘密主题「Vilmy~」！",
        "p.ready": "就绪。",
        "p.start": "正在启动…",
    ...
    "es": {
        ...
        "clicker.unlocked": "¡Tema secreto «Vilmy~» desbloqueado!",
        "p.ready": "Listo.",
        "p.start": "Iniciando…",
    ...
    "de": {
        ...
        "clicker.unlocked": "Geheimes Design „Vilmy~“ freigeschaltet!",
        "p.ready": "Bereit.",
        "p.start": "Starte…",
